...
projekktor = $p = function() {
    ...
    this.config = new projekktorConfig('1.2.36');
        ...
        for(var i in $p.mmap ) {
            if ($p.mmap.hasOwnProperty(i)) {
                ...
                $.each(platforms, function(_na, platform) {
                    ...
                    if ($p.mmap[i].streamType==null || data.config.streamType==null || $.inArray(data.config.streamType, $p.mmap[i].streamType)>-1) {
